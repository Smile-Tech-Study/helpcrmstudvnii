...
Личный кабинет гражданина. Где необходимо будет загрузить документы, проверить и заполнить данные, необходимые образовательной организации для зачисления на выбранную программу.

## Вход в личный кабинет

Вход в личный кабинет доступен по ссылке <https://lk.flow-crm.study/Cabinet/Login>

## Подробнее о работе в личном кабинете

:::danger 

Важно! Параллельно с оформлением документов в организации необходимо будет подписать **Договор о намерениях** на портале Работа России (для обучения на некоторых программах может потребоваться  дополнительно предоставить в ЦЗН справку о пройденном мед. осмотре).
...
Ваши документы проверяет представитель вашей образовательной организации. Параллельно ваша заявка проверяется в ЦЗН. В ЦЗН вас попросят прийти лично или запишут на онлайн-консультацию (подробнее о требованиях конкретного ЦЗН сообщат в информационном письме или в звонке).
...
Вы можете приступить к обучению. Обучение будет проходить на платформе [Odin](https://gramax.smile-tech.study/OdinStudents_help).
